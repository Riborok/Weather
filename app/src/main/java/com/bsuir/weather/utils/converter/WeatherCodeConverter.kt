...
object WeatherCodeConverter {
    ...
    private val weatherInfoMap: Map<Int, WeatherInfo> = mapOf(
        ...
        80 to WeatherInfo(R.string.weather_light_rain_showers) { _ -> R.drawable.rain_drop },
        81 to WeatherInfo(R.string.weather_moderate_rain_showers) { _ -> R.drawable.rain_drop },
        82 to WeatherInfo(R.string.weather_heavy_rain_showers) { _ -> R.drawable.rain_drop },
